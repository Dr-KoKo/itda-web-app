...
const navigation = [
  { name: "Job Posts", href: "/job-posts" },
  { name: "Team Posts", href: "/team-posts" },
  { name: "Random Match", href: "/random-match" },
];
    ...
    <>
      <nav aria-label="Global" className="flex items-center justify-between p-4 lg:px-8">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="/log-in" className="text-sm/6 font-semibold text-gray-300 hover:text-white">
